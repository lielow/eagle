...
<pad name="V+" x="-6.1" y="6" drill="1.3" diameter="2.1"/>
...
<part name="RELAY" library="Seeed-OPL-Relay" deviceset="RELAY-SONGLE" device="" value=""/>
...
<part name="MSW" library="con-molex" deviceset="53?-02" device="048" value=""/>
...
<instance part="RELAY" gate="G$1" x="182.88" y="5.08"/>
...
<instance part="MSW" gate="-1" x="254" y="58.42" rot="R180"/>
<instance part="MSW" gate="-2" x="254" y="60.96" rot="R180"/>
...
<net name="M-SW+" class="0">
<segment>
<pinref part="MSW" gate="-2" pin="S"/>
